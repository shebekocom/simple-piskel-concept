...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return addNewFrame; });\n// add new frame\nfunction addNewFrame() {\n  var canvasFrames = document.querySelectorAll('[data-title-name]');\n  canvasFrames.forEach(function (item) {\n    item.classList.remove('selected_canvas');\n  });\n  document.querySelector('.frame-list').insertAdjacentHTML('beforeend', \"<li class=\\\"frame-title\\\" data-title-name=\\\"\".concat(canvasFrames.length, \"\\\">\\n  <div class=\\\"canvas-bg\\\">\\n      <div></div>\\n      <canvas class=\\\"frame-canvas\\\" data-canvas-count=\\\"\").concat(canvasFrames.length, \"\\\" width=\\\"32\\\" height=\\\"32\\\"></canvas>\\n  </div>\\n  <div class=\\\"frame-number\\\">\").concat(canvasFrames.length + 1, \"</div>\\n  <div class=\\\"del-frame\\\"></div>\\n  <div class=\\\"move-frame\\\"></div>\\n  <div class=\\\"duplicate-frame\\\"></div>\\n</li>\"));\n  document.querySelector('.frame-title:last-child').classList.add('selected_canvas');\n}\n\n//# sourceURL=webpack:///./src/modules/addNewFrame.js?");
